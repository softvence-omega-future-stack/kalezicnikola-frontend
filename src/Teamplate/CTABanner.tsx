      ...
      <div className="xl:px-30">
        <div className="bg-[#526FFF] rounded-3xl sm:rounded-[2.5rem] md:rounded-[3rem] lg:rounded-[3.5rem] p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 shadow-2xl">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 sm:gap-8">
            ...
            {/* Right Button with iOS-style Glass Effect */}
<div className="relative">
  {/* Glass background */}
  <div className="absolute inset-0 bg-white/10 backdrop-blur-lg rounded-full sm:rounded-2xl"></div>

  {/* Button */}
  <button
    onClick={() => navigate('/signup')}
    className="relative z-10 text-white bg-[rgba(255, 255, 255, 0.10)] font-semibold px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 md:py-5 
               rounded-full sm:rounded-2xl border border-white/50 
               transition-all duration-300 
                
               active:scale-95 text-sm sm:text-base md:text-lg lg:text-xl 
               whitespace-nowrap shadow-lg cursor-pointer"
  >
    Start Now
  </button>
