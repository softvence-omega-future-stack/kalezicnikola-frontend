        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[30px] lg:gap-[30px]">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Sub Description */}
              <p className="text-headingBlack text-sm md:text-base font-normal leading-[22px]">
