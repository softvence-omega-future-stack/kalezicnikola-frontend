...
const ExampleSection: React.FC = () => {
  ...
  const menuItems = [
    ...
    { title: "Appointment Rescheduling/Cancellation", subtitle: "Dental Practice Dr. Meier" },
    { title: "Insurance Questions", subtitle: "Physiotherapy Dr. Fuchs" },
    { title: "Booking a Preventive Appointment", subtitle: "General Practice Dr. Koch" },
    ...
    <div style={{ fontFamily: "Urbanist, sans-serif" }} className="mt-12 md:mt-[120px]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 sm:gap-8">
        <SectionHeader
          ...
          heading={<>This is what Docline sounds like in everyday practice</>}
...
//   const AudioPlayer = () => (
//     <div className="mt-2">
//       <div className="bg-[#526FFF] rounded-xl md:rounded-3xl p-4 md:p-6">
//         <div className="mb-4">
//           <h3 className="text-white sm:h-10 text-base sm:text-xl font-semibold mb-2">
//             {activeItem.title}
//           </h3>
...
//                   >
//                     <img src={roundImg} alt="border" className="absolute inset-0 w-full h-full object-cover" />
//                     {isActive && <img src={roundactiveImg} alt="active" className="absolute w-full h-full object-cover z-10" />}
//                   </div>
//                 </div>
//               );
//             })}
...
//           heading={
//             <>
//               This is what Docline sounds like in everyday practice
//             </>
//           }
//           subText="Your patients will hardly notice the difference. Easily adapt the AI assistant's voice to your practice's style. Choose a confident male or female voice. This ensures a smooth and professional reception for every call."
//           align="left"
...
//         {/* Right Section */}
//         <div className="w-full">
//           {/* All Menu Items with Audio Player Moving Between Them */}
//           <div className="-space-y-1">
//             {menuItems.map((item, index) => {
...
//                       <h4 className="text-headingBlack font-semibold text-base sm:text-xl mb-1">
//                         {item.title}
//                       </h4>
//                       <p className="text-subHeadingBlack text-sm md:text-base">
//                         {item.subtitle}
//                       </p>
//                     </div>
...
//                   {/* Audio Player appears below the active item */}
//                   {isThisItemActive && <AudioPlayer />}
//                 </div>
//               );
//             })}
//           </div>
...
//   const [isPlaying, setIsPlaying] = useState(false);
//   const [currentTime, setCurrentTime] = useState(33);
//   const [activeAudioIndex, setActiveAudioIndex] = useState<number>(0); // First item open by default
//   const totalDuration = 100;
...
//   // Handle card click - open/close and play/pause
//   const handleCardClick = (index: number) => {
//     if (activeAudioIndex === index) {
//       // Clicking the already-open card toggles play/pause
//       setIsPlaying((prev) => !prev);
//     } else {
//       // Clicking a different card: close current, open new, and start playing
//       setActiveAudioIndex(index);
//       setIsPlaying(true);
//       setCurrentTime(0);
//     }
...
//                   {/* Card */}
//                   <div
//                     className="w-full flex flex-col items-start gap-6 p-4 sm:p-6 rounded-xl md:rounded-3xl border border-white bg-white shadow-[0_-20px_50px_rgba(147,170,189,0.30)] hover:shadow-lg transition-all duration-300 ease-in-out relative cursor-pointer"
//                     onClick={() => handleCardClick(index)}
//                   >
//                     <div className="text-left flex-1">
//                       <h4 className="text-headingBlack font-semibold text-base sm:text-xl mb-1">
...
//                       }}
//                       className="w-12 h-12 bg-gray-200 hover:bg-[#526FFF] rounded-full flex items-center justify-center hover:scale-105 transition-all duration-300 ease-in-out shadow-lg absolute right-6 top-1/2 -translate-y-1/2"
//                     >
//                       {isThisItemPlaying ? (
//                         <Pause size={20} className="text-white" />
//                       ) : (
...
//                   {/* Audio Player - Smooth Expand/Collapse Animation */}
//                   <div
//                     className={`transition-all duration-500 ease-in-out overflow-hidden ${isThisItemActive ? "max-h-[500px] opacity-100 mt-2" : "max-h-0 opacity-0 mt-0"
//                       }`}
//                   >
//                     <AudioPlayer
//                       title={item.title}
