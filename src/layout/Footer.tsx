            ...
            <div className="mx-auto w-[92%] sm:w-[88%] md:w-[80%]">
                ...
                ">
                    <div className="text-center mb-8 relative z-10">
                        <div className="flex items-center justify-center gap-2 mb-4">
                            <svg width="20" height="40" viewBox="0 0 20 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M0.55283 5.94131C1.32579 14.3341 2.96819 17.1604 8.16982 19.0512L12.5171 20.6304L8.42714 21.8369C3.4959 23.2906 1.39615 26.6904 0.570922 34.5611L0 40L3.4185 39.2751C25.5257 34.5878 25.5277 5.32522 3.42151 0.712997L0.00502572 0L0.55283 5.94131Z" fill="#526FFF"/>
                            </svg>
                    ...
                    <div className="absolute w-full inset-x-0 bottom-0 z-0 pointer-events-none opacity-50">
                        <ShadowBox width="321px" height="232px" color="#283AFF" borderRadius="321px" blur="200px" className="top-24 -left-20 absolute" />
                        <ShadowBox width="256px" height="295px" color="#72FF5C" borderRadius="295px" blur="350px" className="top-32 left-1/2 transform translate-x-1/2 absolute" />
                        <ShadowBox width="256px" height="295px" color="#283AFF" borderRadius="295px" blur="350px" className="top-0 right-0 absolute" />
                        <ShadowBox width="321px" height="232px" color="#5EF3A3" borderRadius="321px" blur="300px" className="top-24 -right-16 absolute" />
                    </div>
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 text-center sm:text-left">
                        ...
                        <div className="flex items-center justify-center gap-2">
                            {socialLinks.map((social, index) => (
                                <a key={index} href={social.href} aria-label={social.label} className="w-10 h-10 flex items-center justify-center hover:text-blue-600 transition-colors">
                                    {social.icon}
                                </a>
                            ))}
                        </div>
