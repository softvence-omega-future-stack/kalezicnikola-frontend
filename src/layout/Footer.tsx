...
const Footer: React.FC = () => {
    ...
    return (
        <footer style={{ fontFamily: 'Urbanist, sans-serif' }} className="w-full relative overflow-hidden">
            <div className="mx-auto" style={{ width: '80%' }}> 
                {/* Top Section: Logo, Email, Navigation */}
                <div
                    className="rounded-[100px] flex flex-col relative transition-all duration-300"
                ...
                >
                    <div className="px-4 md:px-0">
                        ...
                        {/* Shadow/Blur Divs under NavLinks (Footer-specific) */}
                        <div className="absolute inset-x-0 bottom-0 z-0 pointer-events-none">
                            <div className="absolute -bottom-24 -left-20 w-[321px] h-[232px] rounded-full bg-blue-600/20 blur-[200px]"></div>
                            <div className="absolute -bottom-32 left-1/2 transform -translate-x-1/2 w-[256px] h-[295px] rounded-full bg-green-400/20 blur-[350px]"></div>
                            <div className="absolute -bottom-32 right-20 w-[256px] h-[295px] rounded-full bg-blue-600/20 blur-[350px]"></div>
                            <div className="absolute -bottom-24 -right-16 w-[321px] h-[232px] rounded-full bg-teal-400/20 blur-[300px]"></div>
                        </div>
                    </div>
                </div>
