...
</svg>, href: 'https://www.linkedin.com/company/107365420/admin/dashboard/', label: 'LinkedIn' },
        { icon: <svg width="20" height="20" viewBox="0 0 20 20"  fill="currentColor"  xmlns="http://www.w3.org/2000/svg">
...
</svg>, href: 'https://www.facebook.com/doclineai', label: 'Facebook' },
        { icon: <svg width="20" height="20" viewBox="0 0 20 20"  fill="currentColor"   xmlns="http://www.w3.org/2000/svg">
...
</svg>, href: 'https://www.instagram.com/docline.ai', label: 'Instagram' }
    ];
  ...
  {legalLinks.map((link, index) => (
    ...
    >
      {link.label}
                        ...
                        {/* SOCIAL ICONS */}
                        <div className="flex items-center justify-center hover:text-blue-600  gap-2">
                            {socialLinks.map((social, index) => (
                                <a
                                    key={index}
                                    href={social.href}
                                    aria-label={social.label}
                                    className="w-10 h-10 flex items-center justify-center  hover:text-blue-600  transition-colors"
                                >
                                    {social.icon}
                                </a>
                            ))}
