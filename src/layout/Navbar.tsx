  ...
  return (
    <div className="relative w-full h-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        {/* Shape 2 - Green (#72FF5C), blur 100px */}
        <div 
          className="absolute flex-shrink-0"
          style={{
            width: '256px',
        ...
        {/* Shape 3 - Sky Blue (#2B8EFF), blur 150px */}
        <div 
        ...
        {/* Shape 4 - Purple Blue (#526FFF), blur 150px */}
        <div 
          className="absolute flex-shrink-0"
          style={{
            width: '452px',
        ...
        {/* Shape 5 - Mint Green (#5EF3A3), blur 100px */}
        <div 
          className="absolute flex-shrink-0"
          style={{
            width: '256px',
      ...
      {/* Navbar Content */}
      <nav className="relative flex justify-between items-center px-16 h-20 z-10">
          ...
          {['Home','About','Services','Portfolio','Contact'].map((item) => (
            <li key={item}>
              <a 
                ...
                className="text-white no-underline text-lg font-medium transition-all duration-300 px-4 py-2 rounded-lg hover:bg-white/15 hover:-translate-y-0.5"
