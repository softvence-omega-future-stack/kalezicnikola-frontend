...
const DateRangePicker = () => {
  ...
  // ✅ API call that dispatches custom event with filtered data
  const handleApply = async () => {
    ...
    try {
      ...
      // Dispatch event with empty data
      window.dispatchEvent(new CustomEvent('callsFiltered', { 
        detail: {
          data: [],
          startDate,
  ...
  const handleClear = () => {
    ...
    // Dispatch event to reload all data
  ...
  return (
    <div className="relative w-full max-w-[260px]">
      ...
      {showCalendar && (
        <div
          ref={dropdownRef}
          className="absolute top-full left-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg p-6 z-50 min-w-[300px]"
        >
