...
const PatientTranscriptPage: React.FC<PatientTranscriptPageProps> = ({ callData }) => {
  ...
  return (
    <div style={{ fontFamily: 'Urbanist, sans-serif' }} className="p-2 sm:p-6 relative bg-[#F3F6F6D9] backdrop-blur-md rounded-4xl ">
      ...
      <h2 className="text-2xl md:text-2xl font-semibold text-[#171C35] mb-6">
      ...
      <div className="mb-2.5 p-5 md:p-6 bg-[#F5F5F5] border border-[#FFFFFF] rounded-[32px]">
        ...
        >
          {showFullSummary ? t('dashboard.routes.callLogs.modal.hide') : t('dashboard.routes.callLogs.modal.showMore')}
        </button>
      </div>
      ...
      <div className="mb-8 p-5 md:p-6">
        <h3 className="text-lg md:text-xl font-semibold text-[#171C35] mb-4">{t('dashboard.routes.callLogs.modal.patientsTranscript')}</h3>
