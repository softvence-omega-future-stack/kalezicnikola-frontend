    ...
    <div className="w-full font-urbanist">
      <div className="w-full">
        ...
        <div className="flex items-center justify-between gap-4 flex-nowrap overflow-x-auto scrollbar-hide">
          {/* Current Time */}
          <span className="text-black text-sm min-w-[45px]">{formatTime(currentTime)}</span>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* FIXED: Same size container for both states */}
            <button 
              onClick={() => setIsPlaying(!isPlaying)} 
              className="cursor-pointer w-10 h-10 flex items-center justify-center transition-transform hover:scale-105"
            >
              {isPlaying ? (
          ...
          <div className="flex items-center gap-4">
            <span className="text-black text-sm min-w-[50px]">{remainingTimeString}</span>
