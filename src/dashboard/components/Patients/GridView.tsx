              ...
              <div key={index} className="bg-white rounded-3xl shadow-sm p-6 hover:shadow-md transition-shadow border border-gray-100">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xl font-bold text-[#171C35] mb-0.5">Floyd Miles</h3>
                    <p className="text-lg text-[#171C35] font-Normal">SRN-10101</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-4 mb-6">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-[#171C35]">+880 1234 56 78</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-800 mb-1">Email</p>
                    <p className="text-lg font-semibold text-[#171C35] truncate">username@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg font-normal text-[#171C35]">01-09-2025 at 10:01 AM</p>
                </div>

                {/* Address */}
                <div className="mb-6">
                  <p className="text-sm font-medium text-gray-800 mb-1">Address</p>
                  <p className="text-lg font-normal text-[#171C35]">A-103, shyam gokul flats, Mahatma</p>
                </div>
                ...
                <button        onClick={() => navigate(`/dashboard/patients/${patient.id}`)}
                  className={`w-full py-3 rounded-full font-medium transition-colors ${
                    index === 1 
                      ...
                      : 'bg-white text-[#171C35] border border-gray-300 hover:bg-gray-50'
                  }`}
                >
                  View
                </button>
