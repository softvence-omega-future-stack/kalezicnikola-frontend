            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171C35] whitespace-nowrap">Date</th>
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171c35] whitespace-nowrap">Name</th>
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171c35] whitespace-nowrap">Transaction ID</th>
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171c35] whitespace-nowrap">Status</th>
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171c35] whitespace-nowrap">Pay Amount</th>
                  <th className="text-left py-4 px-2 sm:px-4 text-sm sm:text-base font-medium text-[#171c35] whitespace-nowrap">Action</th>
                </tr>
              </thead>
