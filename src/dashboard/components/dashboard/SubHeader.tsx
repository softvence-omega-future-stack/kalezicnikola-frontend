...
<path
  d={`M${width} ${defaultHeight} C${width} ${
    defaultHeight - (index === 0 ? 8 : 12)
  } ${width - (index === 0 ? 5 : 20)} ${defaultHeight - (index === 0 ? 8 : 12)} ${
    width - (index === 0 ? 5 : 18)
  } ${defaultHeight} Z`}
  fill="black"
/>
...
{/* Main cutout */}
<path
  d={`M${width} ${defaultHeight - (index === 0 ? 50 : 64)}H${
    width - (index === 0 ? 20 : 34)
  }C${width - (index === 0 ? 33 : 50.5685)} ${
    defaultHeight - (index === 0 ? 50 : 64)
  } ${width - (index === 0 ? 45 : 64)} ${
    defaultHeight - (index === 0 ? 38.807 : 50.569)
  } ${width - (index === 0 ? 45 : 64)} ${defaultHeight - (index === 0 ? 25 : 34)}V${
    defaultHeight
  }H${width}V${defaultHeight - (index === 0 ? 70 : 90)}C${width} ${
    defaultHeight - (index === 0 ? 58.954 : 75.641)
  } ${width - (index === 0 ? 5 : 11.6405)} ${
    defaultHeight - (index === 0 ? 50 : 64)
  } ${width - (index === 0 ? 15 : 26)} ${defaultHeight - (index === 0 ? 50 : 64)}H${width}Z`}
  fill="black"
/>

{/* Left side small cutout */}
<path
  d={`M${width - (index === 0 ? 45 : 63)} ${defaultHeight}V${
    defaultHeight - (index === 0 ? 18 : 26)
  }C${width - (index === 0 ? 45 : 63)} ${
    defaultHeight - (index === 0 ? 8.954 : 11.641)
  } ${width - (index === 0 ? 53 : 74.6405)} ${defaultHeight} ${
    width - (index === 0 ? 65 : 89)
  } ${defaultHeight}H${width - (index === 0 ? 45 : 63)}Z`}
  fill="black"
/>
  ...
  {category.description}
        ...
        <div
          className={`absolute  ${
            index === 0 ? "bottom-2 right-2 2xl:right-3 2xl:bottom-1 " : "bottom-3 right-3 xl:-right-2 2xl:-right-0 "
          }`}
        >
