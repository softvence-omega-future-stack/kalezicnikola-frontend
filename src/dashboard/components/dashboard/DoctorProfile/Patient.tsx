...
const Patient = () => {
  ...
  return (
    <div className='bg-white'>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-2xl tracking-tighter font-bold text-[#171C35]">Patients History</h3>
  ...
  <tr className="bg-gray-50 border-b border-gray-200">
    ...
    <th className="text-left text-md font-semibold text-[#171C35] tracking-wider px-3 py-3">
      Insurance ID
    </th>
    <th className="text-left text-md font-semibold text-[#171C35] tracking-wider px-6 py-3">
      Name
    </th>
    <th className="text-left text-md font-semibold text-[#171C35] tracking-wider px-6 py-3">
      Phone Number
...
<tbody className="divide-y divide-gray-200">
  {patients.map((patient, idx) => (
    <tr key={idx} className="bg-gray-50 transition-colors">
      ...
      <td className="px-3 py-4 whitespace-nowrap text-md font-normal text-[#171C35]">
        {patient.id}
      </td>
      <td className="px-6 py-4 whitespace-nowrap text-md font-normal text-[#171C35]">
        {patient.name}
      </td>
      <td className="px-6 py-4 whitespace-nowrap text-md font-normal text-[#171C35]">
        {patient.phone}
